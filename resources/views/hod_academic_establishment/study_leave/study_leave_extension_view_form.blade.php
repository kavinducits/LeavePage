...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                            ...
                            @forelse(($approvedProgressReports ?? collect()) as $report)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('hodacademicestablishment.studyLeaveProgress.view', $report->progress_report_id) }}?from={{ $from ?? 'submitted' }}"
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white fw-semibold">
                <i class="fas fa-clipboard-check me-2"></i>Head Of Academic Establishment Review & Recommendation
            </div>
            <div class="card-body">
                <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            hodReviewForm.addEventListener('submit', function(e) {
                ...
                AppPopup.confirm({
                    ...
                    text: 'Are you sure you want to submit this review and forward to Department HOD?',
                    icon: 'question',
