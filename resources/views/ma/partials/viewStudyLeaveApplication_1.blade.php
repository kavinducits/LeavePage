...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0 fw-bold text-maroon dashboard-header">
                ...
                Study Leave Application - View
            </h2>
        </div>
        <a href="{{ route('ma.index') }}" class="btn btn-outline-maroon">
    ...
    <div class="card mb-4 border-primary">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="fw-bold text-primary">Reference No: <span class="text-dark">{{ $application->reference_no ?? 'N/A' }}</span></h5>
                </div>
                <div class="col-md-6 text-end">
                    <h5 class="fw-bold">Status: 
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ ucfirst($application->air_passage_request ?? '') }}" readonly>
                </div>
                <!-- Warm Cloth Allowance -->
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Warm Cloth Allowance Request</label>
                    <input type="text" class="form-control" value="{{ ucfirst($application->warm_cloth_allowance_request ?? '') }}" readonly>
                </div>
            </div>
        </div>
    </div>
    ...
    @if(isset($application->hod_approval) || isset($application->dean_approval) || isset($application->vc_approval))
    <div class="card mb-4">
        <div class="card-header card-header-maroon fw-semibold">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" value="{{ $application->hod_approval ?? 'Pending' }}" readonly>
                </div>
                <!-- Dean Approval -->
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Dean/Registrar</label>
                    <input type="text" class="form-control" value="{{ $application->dean_approval ?? 'Pending' }}" readonly>
                </div>
                <!-- VC Approval -->
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Vice Chancellor</label>
                    <input type="text" class="form-control" value="{{ $application->vc_approval ?? 'Pending' }}" readonly>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Remarks Section -->
    @if(isset($application->remarks) && !empty($application->remarks))
    <div class="card mb-4">
        <div class="card-header bg-warning text-dark fw-semibold">
            <i class="fas fa-exclamation-triangle me-2"></i>Remarks
        </div>
        <div class="card-body">
            <pre class="mb-0">{{ $application->remarks }}</pre>
        </div>
    </div>
    @endif
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="{{ route('ma.index') }}" class="btn btn-secondary">
        ...
        <div>
            ...
            @if(isset($canApprove) && $canApprove)
                <a href="{{ route('ma.approve', $application->id) }}" class="btn btn-success me-2">
                    <i class="fas fa-check me-2"></i>Approve
                </a>
                <a href="{{ route('ma.return', $application->id) }}" class="btn btn-warning">
