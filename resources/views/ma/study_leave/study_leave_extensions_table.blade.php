        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Total Extensions</span>
                    <span class="info-box-number">{{ $extensionApplications->count() ?? 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ isset($extensionApplications) ? $extensionApplications->where('status', 'Processing MA')->count() : 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ isset($extensionApplications) ? $extensionApplications->whereNotIn('status', ['Processing MA'])->count() : 0 }}</span>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ isset($extensionApplications) ? $extensionApplications->where('extension_applied_date', '>=', now()->startOfDay())->count() : 0 }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body border-bottom search-sort-section">
            <form method="GET" action="{{ request()->url() }}" class="row align-items-end">
                <div class="col-md-4">
                    <label for="search" class="form-label">Search Extensions</label>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="sort_by" name="sort_by">
                        <option value="extension_applied_date" {{ request('sort_by', 'extension_applied_date') == 'extension_applied_date' ? 'selected' : '' }}>Applied Date</option>
            ...
            <div class="mt-3">
                ...
                <div class="btn-group btn-group-sm ml-2" role="group">
                    ...
                    <a href="{{ request()->url() }}?sort_by=extension_applied_date&sort_order=desc"
        ...
        <div class="card-body p-0">
            ...
            @if(request('search') || request('sort_by', 'extension_applied_date') != 'extension_applied_date' || request('sort_order', 'desc') != 'desc')
                <div class="alert alert-info search-results-info mx-3 mt-3">
                    ...
                    @endif
                    @if(request('sort_by', 'extension_applied_date') != 'extension_applied_date' || request('sort_order', 'desc') != 'desc')
                        | Sorted by: <em>{{ ucwords(str_replace('_', ' ', request('sort_by', 'extension_applied_date'))) }}</em>
                        ({{ request('sort_order', 'desc') == 'asc' ? 'Ascending' : 'Descending' }})
                    @endif
                    | Showing {{ $extensionApplications->count() ?? 0 }} result(s)
                </div>
            @endif
                        ...
                        <tbody>
                            @foreach($extensionApplications as $extension)
                                <tr class="hoverable-row">
                                    <td class="px-3">
                                        <span class="fw-semibold text-success">{{ $extension->reference_no }}</span>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $statusText = $extension->status ?? 'Processing MA';
