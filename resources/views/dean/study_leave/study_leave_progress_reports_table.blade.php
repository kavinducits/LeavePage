<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-muted">Progress Reports Pending Dean Review</div>
    </div>
        ...
        <div class="card-body p-0">
                            ...
                            @foreach ($progressReportApplications as $application)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('dean.show.studyleave.progressreport', $application->progress_report_id) }}"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">There are no progress reports currently waiting for Dean review.</p>
                </div>
            @endif
        </div>
    </div>
