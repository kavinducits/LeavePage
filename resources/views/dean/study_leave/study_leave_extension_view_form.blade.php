...
<div class="container py-4">
    ...
    <!-- HOD Remarks (if any) -->
    @if(!empty($extension->hod_remarks) || !empty($extension->hod_recommend))
    <div class="card mb-4">
        <div class="card-header card-header-dark text-white fw-semibold">
            <i class="fas fa-comment-dots me-2"></i>HOD Review & Remarks
        </div>
        <div class="card-body">
            @if(!empty($extension->hod_recommend))
            <div class="mb-3">
                <label class="form-label fw-semibold">HOD Recommendation</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" disabled 
                           {{ $extension->hod_recommend == 'yes' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" disabled 
                           {{ $extension->hod_recommend == 'no' ? 'checked' : '' }}>
                    <label class="form-check-label">
                        No - Not Recommended
                    </label>
                </div>
