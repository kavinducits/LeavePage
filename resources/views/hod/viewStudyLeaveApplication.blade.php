    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="{{ $application->name_with_initials ?? '' }}"
                    readonly>
            </div>
            <!-- Designation -->
            <div class="col-md-6">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="{{ $application->leave_payment_type ?? '' }}"
                    readonly>
            </div>
            <!-- Period From -->
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="{{ $application->scholarship_source ?? '' }}"
                    readonly>
            </div>
            <!-- Scholarship Amount -->
            <div class="col-md-6">
                <label class="form-label fw-semibold">Scholarship Amount</label>
                <input type="text" class="form-control" value="{{ $application->scholarship_amount ?? '' }}"
                    readonly>
            </div>
            <!-- Project Name -->
            <div class="col-md-6">
                    ...
                    <tbody>
                        @foreach ($previousLeaves as $leave)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $leave->prev_completed == 'Completed' ? 'success' : 'warning' }}">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee No</label>
                <input type="text" class="form-control" value="{{ $application->teaching_nominee_emp_no ?? '' }}"
                    readonly>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee Name</label>
                <input type="text" class="form-control" value="{{ $application->teaching_nominee_name ?? '' }}"
                    readonly>
            </div>
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee No</label>
                <input type="text" class="form-control" value="{{ $application->admin_nominee_emp_no ?? '' }}"
                    readonly>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee Name</label>
                <input type="text" class="form-control" value="{{ $application->admin_nominee_name ?? '' }}"
                    readonly>
            </div>
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee No</label>
                <input type="text" class="form-control" value="{{ $application->other_nominee_emp_no ?? '' }}"
                    readonly>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-semibold">Employee Name</label>
                <input type="text" class="form-control" value="{{ $application->other_nominee_name ?? '' }}"
                    readonly>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control"
                    value="{{ $application->library_and_property_handling ?? '' }}" readonly>
            </div>
            <!-- Loan Handling -->
            <div class="col-md-6">
