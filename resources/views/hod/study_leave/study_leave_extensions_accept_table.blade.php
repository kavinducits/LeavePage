<!-- Accepted Study Leave Extension Applications Table - HOD -->
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0 fw-bold text-dark">Accepted Study Leave Extension Applications</h2>
        <div class="text-muted">Extensions Already Forwarded by HOD</div>
    </div>
                            ...
                            @foreach ($extensionApplications as $extension)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('hod.show.extension', $extension->extension_id) }}?from=accepted"
