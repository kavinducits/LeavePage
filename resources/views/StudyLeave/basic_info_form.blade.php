                ...
                <div class="row g-3">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="passport_no" class="form-control" value="{{ $draft_study_leave->passport_no ?? '' }}" {{ $readonly ?? true ? 'readonly' : '' }}>
                                        </div>
                                        <!-- Passport Validity -->
                                        
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Validity date up to:</label>
                                            <input type="date" name="passport_validity" class="form-control" value="{{ $draft_study_leave->passport_validity ?? '' }}" {{ $readonly ?? true ? 'readonly' : '' }}>
                                        </div>
            </div>
        </div>