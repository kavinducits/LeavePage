<div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('vc.leave.index') }}" class="nav-link{{ (isset($pageName) && $pageName == 'Applications') ? ' active' : '' }}">
                         ...
                         <li class="nav-item has-treeview{{ isset($pageName) && $pageName == 'Study Leave Extensions' ? ' menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('vc.study.leave.extensions') }}" class="nav-link{{ (request()->routeIs('vc.study.leave.extensions') || (request()->routeIs('vc.show.extension') && request()->get('from') != 'accepted')) ? ' active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>In Review</p>
                                    </a>
                                </li>
