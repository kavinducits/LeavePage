<!-- Accepted Study Leave Extension Applications Table - VC -->
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-muted">Extensions Already Approved by VC</div>
    </div>
        ...
        <div class="card-body p-0">
                                ...
                                <tr class="hoverable-row">
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $statusText = $extension->status ?? 'Approved';
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('vc.show.extension', $extension->extension_id) }}?from=accepted"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">There are no approved extension requests yet.</p>
                </div>
            @endif
        </div>
    </div>
