<!-- Accepted Study Leave Progress Reports Table - VC -->
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0 fw-bold text-dark">
            <i class="fas fa-file-alt me-2 text-success"></i>Accepted Study Leave Progress Reports
        </h2>
        <div class="text-muted">Progress Reports Already Processed by VC</div>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $statusText = $application->status ?? 'Approved';
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('vc.show.studyleave.progressreport', $application->progress_report_id) }}?from=accepted"
