    ...
    public function up(): void
    {
        ...
        $table->string('reference_no')->unique()->nullable();
           ...
           // $table->string('academic_year')->nullable();
            ...
            $table->integer('leave_payment_type')->nullable();
            ...
            $table->integer('air_passage_request')->nullable();
            $table->integer('warm_cloth_allowance_request')->nullable();
            $table->integer('scholarship_source')->nullable();
